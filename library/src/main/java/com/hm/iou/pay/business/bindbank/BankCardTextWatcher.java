...
public class BankCardTextWatcher implements TextWatcher {
    ...
    public static void bind(EditText editText) {
        new BankCardTextWatcher(editText, DEFAULT_MAX_LENGTH, null);
    }

    public static void bind(EditText editText, int maxLength, OnTextChangedListener listener) {
        new BankCardTextWatcher(editText, maxLength, listener);
    }

    public BankCardTextWatcher(EditText editText, int maxLength, OnTextChangedListener listener) {
